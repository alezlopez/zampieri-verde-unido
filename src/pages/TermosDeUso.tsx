          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-6 md:mb-10">
              <div className="inline-flex items-center justify-center w-12 h-12 md:w-16 md:h-16 bg-zampieri-cream rounded-full mb-4">
                <FileText className="h-6 w-6 md:h-8 md:w-8 text-zampieri-gold" />
              </div>
            ...
            <div className="bg-card rounded-xl shadow-lg border border-border p-4 md:p-8 lg:p-10 prose prose-green max-w-none text-sm md:text-base text-foreground space-y-6 md:space-y-8">
              ...
              {/* 1 */}
              <h2 className="text-lg md:text-xl font-bold text-zampieri-green-dark !mt-8">1. Aceitação dos Termos</h2>
              <p>
                Ao navegar, acessar ou utilizar qualquer funcionalidade disponível neste site, o usuário declara ter lido, compreendido e aceito integralmente estes Termos de Uso, bem como a nossa <a href="/privacidade" className="text-zampieri-gold underline hover:text-zampieri-green-dark">Política de Privacidade</a>. O uso continuado do site após eventuais atualizações destes Termos constitui aceitação das modificações realizadas.
              </p>

              {/* 2 */}
              <h2 className="text-lg md:text-xl font-bold text-zampieri-green-dark !mt-8">2. Descrição do Serviço</h2>
              <p>
              ...
              {/* 3 */}
              <h2 className="text-lg md:text-xl font-bold text-zampieri-green-dark !mt-8">3. Cadastro e Dados do Usuário</h2>
              <p>
              ...
              {/* 4 */}
              <h2 className="text-lg md:text-xl font-bold text-zampieri-green-dark !mt-8">4. Propriedade Intelectual</h2>
              <p>
              ...
              {/* 5 */}
              <h2 className="text-lg md:text-xl font-bold text-zampieri-green-dark !mt-8">5. Responsabilidades do Usuário</h2>
              ...
              {/* 6 */}
              <h2 className="text-lg md:text-xl font-bold text-zampieri-green-dark !mt-8">6. Cookies e Tecnologias de Rastreamento</h2>
              <p>
              ...
              {/* 7 */}
              <h2 className="text-lg md:text-xl font-bold text-zampieri-green-dark !mt-8">7. Limitação de Responsabilidade</h2>
              <p>
              ...
              {/* 8 */}
              <h2 className="text-lg md:text-xl font-bold text-zampieri-green-dark !mt-8">8. Proteção de Dados de Crianças e Adolescentes</h2>
              <p>
              ...
              {/* 9 */}
              <h2 className="text-lg md:text-xl font-bold text-zampieri-green-dark !mt-8">9. Comunicações</h2>
              <p>
              ...
              {/* 10 */}
              <h2 className="text-lg md:text-xl font-bold text-zampieri-green-dark !mt-8">10. Alterações nos Termos de Uso</h2>
              <p>
              ...
              {/* 11 */}
              <h2 className="text-lg md:text-xl font-bold text-zampieri-green-dark !mt-8">11. Legislação Aplicável e Foro</h2>
              <p>
              ...
              {/* 12 */}
              <h2 className="text-lg md:text-xl font-bold text-zampieri-green-dark !mt-8">12. Contato</h2>
              <p>
