export const TestimonialsSection = () => {
  ...
  return (
    <section id="depoimentos" className="py-12 md:py-20 bg-gradient-to-br from-green-50 via-green-100 to-green-200 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12 md:mb-16">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 mb-4 md:mb-6 px-4">
              O que as famílias 
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-green-800"> dizem sobre nós</span>
            </h2>
              ...
              >
                ...
                <div className="relative overflow-hidden rounded-t-3xl">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="relative">
                      <div className="w-16 h-16 md:w-20 md:h-20 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center group-hover:scale-110 transition-all duration-300 border-2 border-white/30">
                        <div className="w-12 h-12 md:w-16 md:h-16 bg-red-600 rounded-full flex items-center justify-center shadow-xl group-hover:bg-red-500 transition-colors duration-300">
                      ...
                      {/* Pulse effect */}
                      <div className="absolute inset-0 w-16 h-16 md:w-20 md:h-20 bg-white/20 rounded-full animate-ping opacity-75 group-hover:opacity-50"></div>
                    </div>
                  </div>
                ...
                <div className="p-4 md:p-8">
                  <div className="flex items-center gap-2 md:gap-3 mb-3 md:mb-4">
                    <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-green-500 to-green-700 rounded-full flex items-center justify-center text-white font-bold text-base md:text-lg flex-shrink-0">
                      {testimonial.family.split(' ')[1][0]}
                    </div>
                    <div>
                      <h3 className="text-lg md:text-2xl font-bold text-gray-800 group-hover:text-green-600 transition-colors duration-300">
                        {testimonial.family}
                      </h3>
                      <p className="text-gray-500 text-xs md:text-sm">Depoimento em vídeo</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2 text-green-600 font-semibold group-hover:gap-3 transition-all duration-300">
                      <span className="text-xs md:text-sm">Assistir</span>
                ...
                {/* Hover effect border */}
                <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-green-500/20 to-green-700/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
              </div>
            ))}
          </div>
          ...
          <div className="text-center mt-12 md:mt-16">
            <button
              ...
              className="inline-flex items-center gap-2 bg-gradient-to-r from-green-600 to-green-800 text-white px-5 py-2.5 md:px-6 md:py-3 rounded-full text-sm md:text-base font-semibold hover:from-green-700 hover:to-green-900 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
            >
              ...
              <span className="hidden sm:inline">Faça parte da nossa família também</span>
              <span className="sm:hidden">Faça parte também</span>
            </button>
          </div>
        </div>
      </div>
