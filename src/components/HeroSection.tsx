...
export const HeroSection = () => {
  ...
  return <section id="inicio" className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-blue-50 pt-[140px]">
      <div className="container mx-auto px-4 py-8">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">Há mais de 40 anos formando cidadãos conscientes e preparados para o futuro. No Colégio Zampieri, cada aluno é único e especial.</p>
          </div>
