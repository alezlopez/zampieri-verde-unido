...
export const HeroSection = () => {
  ...
  return <section id="inicio" className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-blue-50 pt-[120px] md:pt-[140px]">
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="space-y-4 md:space-y-6 text-center md:text-left">
            ...
            <p className="text-base md:text-lg text-gray-700 leading-relaxed">Há mais de 40 anos formando cidadãos conscientes e preparados para o futuro. No Colégio Zampieri, cada aluno é único e especial.</p>
          </div>
              ...
              <CarouselContent>
                {heroImages.map((image, index) => <CarouselItem key={index}>
                    <div className="relative h-64 sm:h-80 md:h-96 w-full">
                      <img src={image.src} alt={image.alt} className="w-full h-full object-cover rounded-lg shadow-2xl" />
